                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <?php echo form_open_multipart('Ctrl_admin/form_edit');?>
                                        <div class="form-group">
                                            <label>ID Menu</label>
                                            <input type="text" name="id_menu" class="form-control" value="<?php echo $id_menu; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input type="text" name="nama_menu" class="form-control" value="<?php echo $nama_menu; ?>" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Gambar</label>
                                            <p class="help-block">Gambar sebelumnya.</p>
                                            <img style="width:300px" src="<?php echo base_url()."gambar/".$gambar ?>">
                                            <input style="margin-top:10px" type="file" name="gambar">
                                        </div>
